...
public class guiPesquisaLojaPecasRegiao extends javax.swing.JInternalFrame {

    public guiPesquisaLojaPecasRegiao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Relatório de Loja de Peças por Região");
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        ...
        List l = new LojaPecasJpaController().getLojaPecasRegiao(b);
